...
<body>
    ...
    <!-- DEBUT MAIN  -->
        <main class="pt-5 mb-5 d-flex" style="height: 834px;">
            <div class="container pt-5 m-auto" id="demos">
                <div class="row flex-column">
                    <h2 class="text-center">
                        Objectif
                    </h2>
                    <p class="text-center">Réalisation d'un petit jeu seulement fait en Javascript.
                    </p>
                </div>
                <div class="row">
...
<script>
    ...
    $('.projet-jeux').click(function(){
        window.open('./JEUX/index.html', '_blank');
      });
